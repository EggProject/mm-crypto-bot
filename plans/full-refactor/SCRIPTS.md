...
| `scripts/dev.sh`                  | Development launcher.               | **REMOVED**; no active caller; obsolete root logs/PID/run-bot coupling.                   | No active caller; obsolete root logs/PID/run-bot coupling.     |
