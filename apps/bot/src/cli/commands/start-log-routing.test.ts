...
import { createStartCommand, runHeadless, startCommand, type RuntimeLogger } from "./start.js";

const RUNTIME_CONFIG_PATH = "/external-runtime-root/config/default.toml";

function resolveRuntimeRoot(): { readonly ok: true; readonly runtimeRoot: string; readonly configPath: string } {
