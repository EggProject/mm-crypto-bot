---
description: Project board — mm-crypto-bot. Updated 2026-07-19 23:30 Budapest — Phase 59.1+59.2 CLOSED (PR #178 commits 8510098+64d03c9). E2E coverage 72.92% / 61.11% / 67.71% (L/B/F) in CI 29704276432, +0.97pp / +4.55pp / +1.57pp from previous best 71.95% / 56.56% / 66.14%. app-helpers.ts went from 50% / 39.74% / 50% to 100% / 96.66% / 100% (AppHelpersProbe CT). 4 strategies-parser branches unlocked via `serviceWorkers: 'block'` per-test bypass. 80/80/80 design target still RED by mandate; gap now 7.08pp / 18.89pp / 12.29pp. Source map misalignment blocks ControlBar/App.tsx branches (Vite dev vs prod build instrument differently for React components with heavy comment blocks).
---
