...
| `apps/config-search/package.json`, `apps/bot/package.json`, root `package.json`   | FUTURE separately approved build/root wiring; excluded from the current 22-path scope.                                      |
