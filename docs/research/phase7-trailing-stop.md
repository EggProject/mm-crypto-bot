...
Közel 60 év adatán a 200-day MA + népszerű stop-loss szabályok **NEM adnak hozzá értéket** a sima MA trend-following-hez képest. A trailing stop-ok a declining market phases-ben valamelyest segítenek, de a pozitív él eltűnik a szigorúbb szabályokkal. Az idézet: _"popular stop loss rules do not add value and that monthly end of month investment decision rules are superior to those which trade more frequently"_.
