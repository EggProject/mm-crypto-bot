...
- **Bybit EU Help Center — „Bybit EU Spot Fees Explained"**
  ...
  _Mit tanultam:_ A spot trading fee **0,1% maker / 0,1% taker** nem-VIP felhasználóknak
...
- **Bybit EU Help Center — „How to Get Started With Spot Margin Trading on Bybit EU"**
  ...
  _Mit tanultam:_ bybit.eu **csak Cross Margin módot** támogat jelenleg spot marginra
...
- **Bybit EU Help Center — „Spot Margin Trading: Fees Explained"**
  ...
  _Mit tanultam:_ Három fee-típus: (1) spot trading fee, (2) hourly interest
...
- **Bybit Learn — „Bybit EU and MiCAR: What European traders need to know"**
  ...
  _Mit tanultam:_ Bybit EU GmbH 2025 májusában kapta meg a MiCAR licencet az osztrák
...
- **PR Newswire — „Bybit EU Empowers European Traders with Spot Margin: Up to 10x Leverage"**
  ...
  _Mit tanultam:_ 2025-08-18, Bécs. bybit.eu 1:10 spot margin indítása. **Liquidation
...
- **Yahoo Finance / CoinDesk — „Crypto Exchange Bybit Introduces 10x Spot Margin Trading in Europe"**
  ...
  _Mit tanultam:_ Bybit = 2. legnagyobb crypto exchange volume alapján. Spot margin
...
- **CCN — „Bybit EU & MiCAR Explained: AI Bots, Spot Margin and Crypto Card"**
  ...
  _Mit tanultam:_ Spot Margin: up to 2x általában, „up to 10x on certain pairs".
...
- **Gate.com Review — „Bybit EU Review: Is This The Best Way To Navigate Europe's..."**
  ...
  _Mit tanultam:_ bybit.eu 2025-07 indulás. **Borrow rate 0,01% / óra USDT**-re.
...
- **Krypto-Leitfaden — „Bybit EU Review 2025 — MiCA-compliant for Austrian traders"**
  ...
  _Mit tanultam:_ Bybit EU GmbH, FMA-regisztrált, MiCAR-licencelt. „One of the
...
- **Cointribune — „Bybit EU lance le trading sur marge spot avec un effet de levier..."**
  ...
  _Mit tanultam:_ BTC/USDC, ETH/USDC párok elérhetők margin-nal. Cross Margin kizárólagos
...
- **Bybit Help — „FAQ — Spot Margin Trading"**
  ...
  _Mit tanultam:_ **Penalty interest** ha a borrowing > 100% maximum: `Penalty Interest
...
- **Bybit — „Trading Rules: Liquidation Process (Unified Trading Account)"**
  ...
  _Mit tanultam:_ Cross Margin és Portfolio Margin módban az MMR 100%-nál triggerelődik
...
- **Learn Bybit EU — „Bybit EU fees: Everything you need to know before trading crypto"**
  ...
  _Mit tanultam:_ Maker/taker fee 0,1% crypto spot-on. Fiat-to-crypto fee-k
...
- **Bybit — „Contract Rules"**
  ...
  _Mit tanultam:_ Funding fee 8 óránként. Interest rate = (USD interest 0,06% -
...
- **Boring Edge — „Bitcoin Donchian Channel Breakout (Turtle Trading) Strategy Backtest"**
  ...
  _Mit tanultam:_ BTC, 2017-2026 (8,5 év), **CAGR 48,2%**, max DD -53,7%, B&H -83,2%.
...
- **Boring Edge — „Bitcoin Supertrend Strategy Backtest — ATR Trend Following"**
  ...
  _Mit tanultam:_ Supertrend (ATR 10, mult 3.0) BTC 2017-2026: **CAGR 33,0%**,
...
- **Boring Edge — „Bitcoin RSI Trend Following Strategy Backtest"**
  ...
  _Mit tanultam:_ **RSI trend-filterként (nem mean-reversion)** a legjobb stratégia:
...
- **dev.to — „I Backtested 49 Crypto Trading Strategies"**
  ...
  _Mit tanultam:_ 49 stratégia rangsorolva. **Top: multi_timeframe (Sharpe 1,50, 546%
...
- **Quantified Strategies — „Trend Following and Momentum Strategies on Bitcoin"**
  ...
  _Mit tanultam:_ SMA crossover BTC: CAGR 115-126%, max DD 39-65%. „Best result was
...
- **CoinQuant — „BTC Trend Following Strategy 4 Hour Backtest Results"**
  ...
  _Mit tanultam:_ EMA 21/55 4H: +9,0% (3 hónap). 12H: -4,9% — a noise túl magas
  12H-n.

- **arXiv (2025) — „A Rigorous Walk-Forward Validation Framework for Market..."**
  https://arxiv.org/html/2512.12924v1
  _Mit tanultam:_ 34 független out-of-sample tesztidőszak, rolling-window validáció,
...
- **Voiceofchain — „Mean Reversion Strategy for Crypto Traders - Practical Guide"**
  ...
  _Mit tanultam:_ BB(20, 2σ) + RSI(14, 4H) + 200 SMA filter. Entry: close < BB lower
...
- **Changelly — „Mean Reversion Trading: Crypto Strategies & Risks"**
  ...
  _Mit tanultam:_ Step-by-step: asset → reference mean (MA) → deviation (z-score) →
...
- **Stratbase — „When Mean Reversion Fails"**
  ...
  _Mit tanultam:_ Backtest-táblázat: **BB+RSI kombó: 68% WR, 1,71 PF, 2,9% átlag
...
- **Quantified Strategies — „Assessing RSI's Effectiveness in Crypto Trading"**
  ...
  _Mit tanultam:_ **A tisztán RSI-alapú mean-reversion BTC-n NEM működik** — fontos
...
- **CryptoProfitCalc — „Mean Reversion Crypto Strategy: The Complete Guide"**
  ...
  _Mit tanultam:_ Bollinger Band Re-entry klasszikus mean reversion. RSI cross-back
...
- **Reddit r/CryptoCurrency — „What is a realistic profit % expectation on a daily trade?"**
  ...
  _Mit tanultam:_ Közösségi tapasztalat: napi 1-3% reális, de csak megfelelő tőkével
...
- **EchoZero — „Scalping Strategy Performance in High-Frequency Crypto Markets"**
  ...
  _Mit tanultam:_ **Medián retail scalper 2-4% / hó díjak előtt**, 60 óra / hét.
...
- **HaasOnline — „Scalper Bot: High-Frequency Crypto Trading"**
  ...
  _Mit tanultam:_ Scalper bot „120% monthly return" elmélet, de „actual results are
...
- **Kraken — „Funding rate arbitrage in crypto: how the strategy works"**
  ...
  _Mit tanultam:_ 5-lépéses módszer: (1) magas pozitív funding azonosítása, (2) long
...
- **Hyperdash — „Basis Trading and Funding Rate Arbitrage on Perps"**
  ...
  _Mit tanultam:_ Cash-and-carry: spot long + perp short. 0,01% / 8h funding → ~11%
...
- **CoinCryptoRank — „Perpetual Futures Basis Arbitrage: Complete Cash-and-Carry Guide"**
  ...
  _Mit tanultam:_ 0,01-0,1% / 8h normál funding, **1-2% daily** extrém piacon.
...
- **PRUVIQ — „Funding Rate Arbitrage: A Practical Guide for Perpetual Futures"**
  ...
  _Mit tanultam:_ Collateral buffer 3-5%, rebalance policy (basis > 0,5% vagy 6 óránként).
  Worst-day loss < 1-2% allokált tőkéből.

- **arXiv 2212.06888 — „Fundamentals of Perpetual Futures"**
  https://arxiv.org/html/2212.06888v5
  _Mit tanultam:_ Funding rate „approximately equals the average futures-spot spread
...
- **Gate.io — „Perpetual Contract Funding Rate Arbitrage Strategy in 2025"**
  ...
  _Mit tanultam:_ 2025 átlag funding rate stabilizálódott 0,015% / 8h-ra a népszerű
  párokon.
...
- **Altrady — „Kelly Criterion for Crypto Position Sizing"**
  ...
  _Mit tanultam:_ `f* = (bp - q) / b`. Példa: 58% WR, 1,5:1 R:R → 25% Kelly. „Half-Kelly
...
- **PRUVIQ — „Position Sizing with Kelly Criterion for Crypto Trading"**
  ...
  _Mit tanultam:_ **„Use approximately 1/20 Kelly (2% of capital per trade)"** a crypto
...
- **Kraken — „Position sizing with leverage: how to size crypto futures positions"**
  ...
  _Mit tanultam:_ Formula: `Position size USD = (Account value × Risk%) / (Entry price -
...
- **HyperTrader — „Kelly Criterion Position Sizing in Volatile Crypto Markets"**
  ...
  _Mit tanultam:_ Folytonos Kelly: `f* = p - q = 2p - 1` szimmetrikus payoff-nál.
...
- **Quantpedia — „Beware of Excessive Leverage – Introduction to Kelly and Optimal F"**
  ...
  _Mit tanultam:_ Ha f*=0,2 és max loss 10%, akkor position size = 0,2/10% = **2×
  leverage** (a teljesítmény-függvény alapján).

- **Wikipedia — „Kelly criterion"**
  https://en.wikipedia.org/wiki/Kelly_criterion
  _Mit tanultam:_ Kelly criterion „maximizes the long-term expected geometric growth
...
- **CoinSwitch — „How to Make $100 a Day Trading Crypto"**
  ...
  _Mit tanultam:_ **„Don't risk more than 1-2% of your total capital on any trade"**.
...
- **Blog Tapbit — „ROI in Crypto Trading 2026: Formulas, Leverage Impact"**
  ...
  _Mit tanultam:_ **2026 realistic benchmarks**: Spot 18-45% / év; Futures (5-20×) top
...
- **Ubi.quest — „Crypto Trading Bot Monthly Returns 2026: What's Realistic?"**
  ...
  _Mit tanultam:_ „**Monthly returns above 30-50% with no explanation** = red flag".
...
- **StormGain — „Crypto Day Trading Guide"**
  ...
  _Mit tanultam:_ „SIPAS strategy: 100-200% per month" **„rather ambitious for a
...
- **Davensi — „Crypto Portfolio Diversification 2026: Asset Allocation, Correlation"**
  ...
  _Mit tanultam:_ **BTC-ETH ρ ≈ 0,85**, BTC-SOL ρ ≈ 0,78, ETH-SOL ρ ≈ 0,82. „During
...
- **Ainvest — „Bitcoin, Ethereum, and Solana as Pillars of a Diversified Crypto Portfolio"**
  ...
  _Mit tanultam:_ BTC-ETH ρ = 0,78, BTC-SOL = 0,67. Intézményi ajánlás: **60-70% BTC/ETH,
...
- **Sharpe AI — „Crypto Correlation Matrix — Live BTC/ETH/SOL..."**
  ...
  _Mit tanultam:_ „0,70-0,90 = strongly correlated, less useful for diversification".
...
- **XBTO — „Crypto Portfolio Allocation 2026: Institutional Guide"**
  ...
  _Mit tanultam:_ „BTC-ETH korreláció 0,7-0,8 — limitálja a két legnagyobb eszköz
...
- **Thrive — „Trading Multiple Crypto Assets: Diversification & Correlation"**
  ...
  _Mit tanultam:_ **„Size positions based on correlation — 3 correlated longs are
...
- **Botter — „The Diversification Illusion: Why BTC + ETH + SOL Isn't Diversified"**
  ...
  _Mit tanultam:_ „Average inter-asset correlations above 0,8 → portfolio risk profile
...
- **arXiv 2209.05559 — „Deep Reinforcement Learning for Cryptocurrency Trading: Practical Approach to Address Backtest Overfitting"**
  ...
  _Mit tanultam:_ Walk-forward „validates in one market situation, which can easily
...
- **Forvest — „Backtest Optimization: Avoid Overfitting & Improve Robustness"**
  ...
  _Mit tanultam:_ **„Walk-forward windows 12-18 months"**, keep tuning modest, lock
...
- **Reddit r/algotrading — „Most quant backtests are lying to you — what Walk-Forward Optimization actually does"**
  ...
  _Mit tanultam:_ Standard backtest tuning on data where outcome already known → overfitting.
...
- **Cryptomantiq — „Overfitting in Crypto: Prevent False-Profitable Backtests"**
  ...
  _Mit tanultam:_ „If your strategy shows 40% annual returns in-sample but only 5%
...
- **Medium Balaena Quant — „Train-Test Split, Cross-Validation and Walk-Forward Testing"**
  ...
  _Mit tanultam:_ „Walk-forward testing is designed precisely to solve the problems
...
- **YouTube — „I Tested 350,000 Bitcoin Strategies. 4 Survived."**
  ...
  _Mit tanultam:_ Walk-forward validation + DD filter → 4 túlélő stratégia 350 000-ből.
...
- **CoinXSight — „Multi-Timeframe Confluence: How Pro Traders Confirm Crypto Signals"**
  ...
  _Mit tanultam:_ 3-timeframe standard: HTF (trend) → MTF (setup) → LTF (entry).
...
- **Mintscript — „Multi-Timeframe Analysis for Crypto Traders"**
  ...
  _Mit tanultam:_ „Only trade when the story is consistent across all three." Top-down
...
- **BingX — „How to Use Multiple Timeframe Analysis for Better Crypto Entries"**
  ...
  _Mit tanultam:_ HTF = trend, MTF = setup, LTF = trigger. „Filter signals, confirm
...
- **Quantpedia — „How to Design a Simple Multi-Timeframe Trend Strategy on Bitcoin"**
  ...
  _Mit tanultam:_ „Look at a higher timeframe to identify the main trend, and then
...
- **AI-Trading-Ranked — „Scalping Crypto Strategy Guide: How I Scalp Bitcoin and Altcoins in 2026"**
  ...
  _Mit tanultam:_ „Scalping requires maker fees below 0,02% and taker fees below 0,055%
...
- **BTCC — „What is Scalping in Crypto? The Ultimate 2025 Guide"**
  ...
  _Mit tanultam:_ Top scalpers 5-15% / hó, átlag 2-5% / hó. 50-300 trade / nap,
  pozíció < 5 perc.

- **Binance Square — „How to Make $100 a Day Trading Cryptocurrency"**
  https://www.binance.com/en-IN/square/post/25075862351474
  _Mit tanultam:_ Day trading = buying/selling same day. Leverage trading „with
...
- **CryptoMaton — „Improvements to backtesting crypto trading algorithm & results"**
  ...
  _Mit tanultam:_ Multi-coin backtest setup, crypto-specifikus adathiány és az
...
- **Cointelegraph — „Is Technical Trading in Cryptocurrency Markets Profitable?"**
  ...
  _Mit tanultam:_ „Simple buy-and-hold of an equally weighted cryptocurrency portfolio
